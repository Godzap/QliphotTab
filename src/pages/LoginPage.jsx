...
import LoginIdlePhase from '../components/auth/LoginIdlePhase'
import LoginInputPhase from '../components/auth/LoginInputPhase'
import LoginAuthenticatingPhase from '../components/auth/LoginAuthenticatingPhase'
import LoginGrantedPhase from '../components/auth/LoginGrantedPhase'
import LoginDeniedPhase from '../components/auth/LoginDeniedPhase'
import CornerBrackets from '../components/auth/CornerBrackets'
import ScanBar from '../components/auth/ScanBar'
...
function normalizeDepartment(department) {
  ...
  if (department === 'Informacao' || department === 'Informação') return 'Informacao'
  if (department === 'Seguranca' || department === 'Segurança') return 'Seguranca'
  return department
}
...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    navigate('/tablet/home', { replace: true })
